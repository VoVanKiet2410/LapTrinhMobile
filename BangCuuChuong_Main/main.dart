...
class _MultiplicationTablePageState extends State<MultiplicationTablePage> {
  ...
  void _generateTable(int number) {
    setState(() {
      _results = List.generate(
          10, (index) => "$number x ${index + 1} = ${number * (index + 1)}");
    });
  }
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              child: Text('Hiển Thị Bảng Cửu Chương'),
            ),
            SizedBox(height: 16),
            Expanded(
